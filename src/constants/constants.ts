...
export const MESSAGE_USER_NOT_FOUND = 'Пользователь не найден';
export const MESSAGE_CARD_NOT_FOUND = 'Карточка не найдена';
export const MESSAGE_INVALID_USER_DATA = 'Переданы некорректные данные пользователя';
